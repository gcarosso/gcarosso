...
**Conclave** — Multi-agent orchestration for Claude, Codex, Gemini, and Grok: task routing, cross-model review, council, recorded checks. [Docs](https://github.com/gcarosso/conclave#readme) · [Source](https://github.com/gcarosso/conclave)
